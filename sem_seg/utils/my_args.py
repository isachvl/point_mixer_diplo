...
def my_args():
    ...
    parser.add_argument('--scannetpp_root')
    ...
    parser.add_argument("--block_size", type=float, default=0.0,
                        help='Optional XY block crop size for train scenes. 0 disables block crop.')
    parser.add_argument("--min_points_in_block", type=int, default=1024)
    parser.add_argument("--min_train_points", type=int, default=0,
                        help='Skip train scenes with fewer labeled points. 0 disables filtering.')
    parser.add_argument("--class_balance_prob", type=float, default=0.0,
                        help='Probability of choosing a rare-class center for train crops.')
    ...
    parser.add_argument("--offset_dir_loss_weight", type=float, default=0.2)
    parser.add_argument("--train_offset_only", type=str2bool, default=False,
                        help='Freeze PointMixer backbone/semantic head and train only panoptic offset head.')
    parser.add_argument("--class_weight_path", default=None,
                        help='Optional .npy/.pt tensor with per-class CE weights.')
    parser.add_argument("--semantic_label_smoothing", type=float, default=0.0)
    parser.add_argument("--semantic_loss_type", type=str, default='ce',
                        help='Semantic loss: ce, focal, lovasz, or focal_lovasz.')
